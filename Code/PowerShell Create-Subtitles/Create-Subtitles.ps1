...
2. Check if a .srt subtitle file has already been created. If not, create subtitles for the media file.
3. If there’s an error condition, report that.
After all files have been processed, change back to the original working directory.
...
$fileList = Get-ChildItem -recurse *.mp4,*.mov,*.avi,*.mkv,*.flv
